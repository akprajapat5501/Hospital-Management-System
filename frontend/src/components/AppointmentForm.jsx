...
const AppointmentForm = () => {
    ...
    useEffect(() => {
        const fetchDoctors = async () => {
            const { data } = await axios.get("https://hospital-management-system-backend-1lms.onrender.com/api/v1/user/doctors", { withCredentials: true });
    ...
    const handleAppointment = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post("https://hospital-management-system-backend-1lms.onrender.com/api/v1/appointment/appointment/post", {
                firstName,
                lastName,
                email,
                phone,
...
//                 "http://localhost:4000/api/v1/appointment/appointment/post",
//                 {
//                     firstName,
//                     lastName,
//                     email,
